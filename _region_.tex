\message{ !name(连续可微可逆映射对单位正方形的作用.tex)}\documentclass[a4paper, 12pt]{article} % Font size (can be 10pt, 11pt or 12pt) and paper size (remove a4paper for US letter paper)
...
\message{ !name(连续可微可逆映射对单位正方形的作用.tex) !offset(-3) }
...
\end{document}
\message{ !name(连续可微可逆映射对单位正方形的作用.tex) !offset(-170) }
